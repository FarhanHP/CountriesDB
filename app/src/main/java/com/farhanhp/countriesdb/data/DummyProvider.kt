...
object DummyProvider {
  val countries = listOf(
    Country(
      ...
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/05/Indonesia_%28orthographic_projection%29.svg/220px-Indonesia_%28orthographic_projection%29.svg.png"
    ), Country(
      1, "Republic of South Africa",
      "South Africa, officially the Republic of South Africa (RSA), is the southernmost country in Africa. South Africa is bounded to the south by 2,798 kilometres (1,739 mi) of coastline that stretch along the South Atlantic and Indian Oceans;[14][15][16] to the north by the neighbouring countries of Namibia, Botswana, and Zimbabwe; and to the east and northeast by Mozambique and Eswatini and it surrounds the enclaved country of Lesotho.[17] It is the southernmost country on the mainland of the Old World, and the most populous country located entirely south of the equator. South Africa is a biodiversity hotspot, with a diversity of unique biomes and plant and animal life. With over 60 million people, the country is the world's 23rd-most populous nation and covers an area of 1,221,037 square kilometres (471,445 square miles). South Africa has three capital cities, with the executive, judicial and legislative branches of government based in Pretoria, Bloemfontein and Cape Town respectively. The largest city is Johannesburg.",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Flag_of_South_Africa.svg/125px-Flag_of_South_Africa.svg.png",
      "https://upload.wikimedia.org/wikipedia/en/thumb/2/21/Coat_of_arms_of_South_Africa.svg/85px-Coat_of_arms_of_South_Africa.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6e/South_Africa_%28orthographic_projection%29.svg/220px-South_Africa_%28orthographic_projection%29.svg.png"
    ), Country(
      ...
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Coat_of_arms_of_Mexico.svg/85px-Coat_of_arms_of_Mexico.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/0/06/MEX_orthographic.svg/200px-MEX_orthographic.svg.png"
    ), Country(
      ...
      "https://upload.wikimedia.org/wikipedia/en/thumb/b/ba/Flag_of_Germany.svg/125px-Flag_of_Germany.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Coat_of_arms_of_Germany.svg/85px-Coat_of_arms_of_Germany.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/EU-Germany_%28orthographic_projection%29.svg/220px-EU-Germany_%28orthographic_projection%29.svg.png"
    ), Country(
      5, "Mongolia",
      "Mongolia, (/mɒnˈɡoʊliə/ (listen), Mongolian: Монгол Улс, romanized: Mongol Uls, Traditional Mongolian: Monggol ulus.svg[a] Moŋğol ulus; lit. \"Mongol Nation\" or \"State of Mongolia\") is a landlocked country in East Asia, bordered by Russia to the north and China to the south. It covers an area of 1,564,116 square kilometres (603,909 square miles), with a population of just 3.3 million, making it the world's most sparsely populated sovereign nation. Mongolia is the world's largest landlocked country that does not border a closed sea, and much of its area is covered by grassy steppe, with mountains to the north and west and the Gobi Desert to the south. Ulaanbaatar, the capital and largest city, is home to roughly half of the country's population.",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/Flag_of_Mongolia.svg/125px-Flag_of_Mongolia.svg.png",
      ...
      "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Coat_of_Arms_of_Australia.svg/85px-Coat_of_Arms_of_Australia.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Australia_with_AAT_%28orthographic_projection%29.svg/250px-Australia_with_AAT_%28orthographic_projection%29.svg.png"
    ), Country(
      ...
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b8/Flag_of_Liberia.svg/125px-Flag_of_Liberia.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/6/64/Coat_of_arms_of_Liberia.svg/85px-Coat_of_arms_of_Liberia.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Liberia_%28orthographic_projection%29.svg/250px-Liberia_%28orthographic_projection%29.svg.png"
    ), Country(
      9, "Republic of Paraguay",
      "Paraguay (/ˈpærəɡwaɪ/; Spanish pronunciation: [paɾaˈɣwaj] (listen)), officially the Republic of Paraguay (Spanish: República del Paraguay; Guarani: Tetã Paraguái), is a country in South America. It is bordered by Argentina to the south and southwest, Brazil to the east and northeast, and Bolivia to the northwest. It has a population of 7 million, nearly 3 million of whom live in the capital and largest city of Asunción, and its surrounding metro. Although one of only two landlocked countries in South America (Bolivia is the other), Paraguay has ports on the Paraguay and Paraná rivers that give exit to the Atlantic Ocean, through the Paraná-Paraguay Waterway.[8]",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/2/27/Flag_of_Paraguay.svg/125px-Flag_of_Paraguay.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/7/70/Coat_of_arms_of_Paraguay.svg/85px-Coat_of_arms_of_Paraguay.svg.png",
      "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4c/PRY_orthographic.svg/250px-PRY_orthographic.svg.png"
    )
  )

  fun getCountryById(countryId: Int) = countries.find { it.id == countryId }
}